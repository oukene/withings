    ...
    async def async_step_init(self, user_input: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema(
                    {
                        vol.Optional(const.CONF_USE_SLEEP_MEASUREMENT, default=options.get(const.CONF_USE_SLEEP_MEASUREMENT, False)): selector.BooleanSelector(selector.BooleanSelectorConfig()),
                        vol.Optional(const.CONF_USE_BODY_MEASUREMENT, default=options.get(const.CONF_USE_BODY_MEASUREMENT, False)): selector.BooleanSelector(selector.BooleanSelectorConfig()),
                        vol.Optional(const.CONF_USE_PRESSURE_MEASUREMENT, default=options.get(const.CONF_USE_PRESSURE_MEASUREMENT, False)): selector.BooleanSelector(selector.BooleanSelectorConfig()),
                        vol.Optional(const.CONF_USE_THERMO_MEASUREMENT, default=options.get(const.CONF_USE_THERMO_MEASUREMENT, False)): selector.BooleanSelector(selector.BooleanSelectorConfig()),
                    }
            ), errors=errors
        )
